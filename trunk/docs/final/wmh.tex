...
który prowadzi do najwiêkszej poprawym, a jako $rselect(x,S)$ funkcjê, która z s¹siedztwa $x$ 
wybiera punkt osi¹galny poprzed modyfikacjê jednej zmiennej w niespe³nionych klauzulach. 
...
Plik konfiguracyjny zadania umo¿liwia:
...
\section{TESTOWANIE}
Ocena jakoœci konkretnego algorytmu odbywaæ siê bêdzie na podstawie 
