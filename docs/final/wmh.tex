...
który prowadzi do najwiêkszej poprawy. Jako punkty s¹siaduj¹ce z $x$ uznajemy te, 
...
naciskiem na szczegó³y implementacyjne (np. warunek aktualizacji wektora $\lambda$). 
